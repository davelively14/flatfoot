...
describe('wards', () => {
  ...
  it('should add a ward to the current state when ADD_WARD called', () => {
  ...
  it('should do nothing if bad id passed when REMOVE_WARD called', () => {
    expect(wards([wardParams1], {type: REMOVE_WARD, ward_id: wardParams2.id})).to.eql([wardParams1]);
  });

  it('should update params of a particular ward entry when UPDATE_WARD called', () => {
  ...
  it('should do nothing when UPDATE_WARD called and passed a ward without an already existing id', () => {
    expect(wards([wardParams1, wardParams2], {type: UPDATE_WARD, ward_params: {id: 4}})).to.eql([wardParams1, wardParams2]);
  });

  it('should set state to default when LOGOUT is called', () => {
    expect(wards([wardParams1], {type: LOGOUT})).to.eql(initialState);
  });

  it('should set state to default when CLEAR_DASHBOARD is called', () => {
