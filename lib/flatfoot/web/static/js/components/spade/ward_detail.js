        ...
        {this.props.ward &&
          <div>
            ...
            <div className="col-sm-4">
              <WardAccountsDetail wardAccounts={this.props.wardAccounts} />
            </div>
            <div className="col-sm-8">
              <ActivityFeed ward={this.props.ward} wardAccounts={this.props.wardAccounts} wardResults={this.props.wardResults} />
            </div>
          </div>
        }
      </div>
