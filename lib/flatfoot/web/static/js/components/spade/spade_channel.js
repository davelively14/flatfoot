...
class SpadeChannel extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (this.props.session.socket != nextProps.session.socket) {
      ...
      if (this.props.user.id != undefined || nextProps.user.id != undefined) {
        let user = nextProps.user ? nextProps.user : this.props.user;
    ...
    if (this.props.session.socket && this.props.user != nextProps.user) {
      let socket = this.props.session.socket;
      let socketChannel = socket.channel('spade:' + nextProps.user.id);
