...
class SpadeChannel extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="row">
        <Modal
          isOpen={this.props.addModal ? true : false}
          contentLabel={this.props.addModal ? this.props.addModal : ''}
          style={modalStyle}
        >
          <div>
            ...
            <div className="col-sm-8">
              <div className="modal-header">
                <button type="button" className="close" aria-label="Close" onClick={this.props.closeAddModal}><span aria-hidden="true">&times;</span></button>
                <h4>Add {this.props.addModal}</h4>
              </div>
              <div className="modal-body">
                <p>Lots of stuff here aksd;lfj k;alsdj fkl;asjd fkl;asdklfj asdlkjfas;dklfa;klds</p>
                <p>Lots of stuff here aksd;lfj k;alsdj fkl;asjd fkl;asdklfj asdlkjfas;dklfa;klds</p>
                <p>Lots of stuff here aksd;lfj k;alsdj fkl;asjd fkl;asdklfj asdlkjfas;dklfa;klds</p>
              </div>
              <div className="modal-footer">
                <button type="button" className="btn btn-default" onClick={this.props.closeAddModal} >Cancel</button>
