...
class WardList extends Component {
      ...
      return (
        <tr className="selected" key={key}>
          ...
          <td>
            ...
            />
            &nbsp;
            <button className="btn btn-xs btn-danger" onClick={() => this.deleteAndRemoveWard(ward.id)}>Delete</button>
          </td>
        </tr>
      );
    } else {
  ...
  render() {
    return(
      <div>
        {/* TODO: Add instructions and title properties for FormModal */}
        <FormModal
          name="addWard"
